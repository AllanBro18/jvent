    ...
    <form action="<?= base_url('/booth/update/') . $booth['id_booth'] ?>" method="post" class="grid grid-cols-1 md:grid-cols-2 gap-6" enctype="multipart/form-data">
        ...
        <div class="md:col-span-2">
            ...
            <input 
                ...
                name="nama_booth" 
                autofocus
                value="<?= old('nama_booth', $booth['nama_booth']); ?>"
        ...
        <div class="md:col-span-2">
            <label for="gambar_booth" class="block mb-2 text-white text-sm font-medium">Gambar Booth (Kosongkan jika tidak ingin diubah)</label>
            <div class="flex items-center space-x-4 mt-2">
                <img src="<?= base_url('uploads/images/' . $booth['gambar_booth']); ?>" class="w-32 h-32 object-cover rounded-lg" alt="Gambar Booth Saat Ini">
                <input
                    type="file"
                    id="gambar_booth"
                    name="gambar_booth"
        ...
        <div class="md:col-span-2">
            ...
            <textarea 
                ...
                rows="4" 
                class="w-full px-4 py-2 bg-transparent border border-white text-white placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary-main"
            ><?= old('lokasi_booth', $booth['lokasi_booth']); ?></textarea>
        ...
        <div class="md:col-span-2">
            ...
            <input 
                ...
                id="kontak_booth" 
                name="kontak_booth" 
                value="<?= old('kontak_booth', $booth['kontak_booth']); ?>"
                class="w-full px-4 py-2 bg-transparent border border-white text-white placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary-main"
        ...
        <div class="md:col-span-2">
            ...
            <textarea 
                ...
                rows="4" 
                class="w-full px-4 py-2 bg-transparent border border-white text-white placeholder-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary-main"
            ><?= old('deskripsi_booth', $booth['deskripsi_booth']); ?></textarea>
