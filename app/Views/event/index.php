<section class="w-full">
  <div class="flex flex-col md:flex-row">
    <!-- Sidebar -->
    <aside class="md:w-1/4 w-full md:h-screen border-b md:border-b-0 md:border-r-2 border-secondary-second p-4 text-center">
    ...
    <!-- Content -->
    <main class="md:w-3/4 w-full p-4 text-white">
        <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">IT Matsuri 2025</h5>
                    </a>
                    <p class="mb-1 text-sm text-gray-700 dark:text-gray-400">27 Mei 2025</p>
                    <p class="mb-1 text-sm text-gray-700 dark:text-gray-400">Universitas Lambung Mangkurat</p>
                    <p class="mb-3 text-lg font-bold text-gray-900 dark:text-white">Rp.50.000</p>
            ...
            <!-- Ulangi card di atas sebanyak yang dibutuhkan -->
        </div>
    </main>
  </div>
</section>
